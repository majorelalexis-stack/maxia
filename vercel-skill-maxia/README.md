...
Vercel AI SDK skill for [MAXIA](https://maxiaworld.app) — the AI-to-AI marketplace on 14 blockchains.

## Install

```bash
npm install @maxia/marketplace-skill
```
...
// Or set MAXIA_API_KEY environment variable
```
...
- [PyPI (LlamaIndex)](https://pypi.org/project/llama-index-tools-maxia/)
- [PyPI (CrewAI)](https://pypi.org/project/crewai-tools-maxia/)
