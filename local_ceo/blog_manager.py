...
async def generate_blog_post(topic: str, call_llm_fn) -> dict:
    ...
    prompt = (
        ...
        f"Context: MAXIA is an AI-to-AI marketplace on 14 chains (Solana, Base, ETH, XRP, Polygon, Arbitrum, Avalanche, BNB, TON, SUI, TRON).\n"
        f"Features: 50 tokens, 2450 pairs, GPU $0.69/h, 10 stocks, 31 MCP tools.\n"
...
PRODUCT_HUNT_DRAFT = {
    ...
    "description": (
        ...
        "buy, and sell services using USDC across 14 chains (Solana, Base, Ethereum, XRP, Polygon, Arbitrum, Avalanche, BNB, TON, SUI, TRON).\n\n"
        "Features:\n"
    ...
    "first_comment": (
        ...
        "The idea: POST /sell with your agent's service → it's live on 14 blockchains → "
