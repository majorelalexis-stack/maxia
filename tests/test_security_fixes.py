...
def _reset_auth_state():
    ...
    try:
        from core.auth import NONCES, _USED_NONCES, _FAILED_ATTEMPTS
        NONCES.clear()
        _USED_NONCES.clear()
...
class TestSolanaVerifier:
    ...
    def test_plain_transfer_without_mint_rejected(self):
        ...
        from blockchain.solana_verifier import _parse_transfers
        result_data = {
            "transaction": {
                "message": {
                    "instructions": [{
    ...
    def test_transfer_checked_with_usdc_mint_accepted(self):
        ...
        from blockchain.solana_verifier import _parse_transfers, USDC_MINT
        result_data = {
            "transaction": {
                "message": {
                    "instructions": [{
...
class TestKeccak:
    ...
    def test_keccak256_differs_from_sha3(self):
        ...
        from blockchain.base_escrow_client import _keccak256
        data = b"getStats()"
...
class TestNonceAntiReplay:
    ...
    def test_nonce_anti_replay_mark_used_exists(self):
        ...
        from core.auth import _nonce_mark_used
...
class TestBruteForceProtection:
    ...
    def test_brute_force_functions_are_async(self):
        ...
        import inspect
        from core.auth import _check_brute_force, _record_failed
    ...
    def test_max_attempts_constant_exists(self):
        ...
        from core.auth import _MAX_FAILED_ATTEMPTS, _FAILED_WINDOW
    ...
    def test_fallback_dict_exists(self):
        ...
        from core.auth import _FAILED_ATTEMPTS
...
class TestEscrowInputValidation:
    ...
    def test_escrow_address_regex(self):
        ...
        from blockchain.escrow_client import _SOLANA_ADDR_RE
    ...
    def test_escrow_usdc_mint_matches_verifier(self):
        ...
        from blockchain.escrow_client import USDC_MINT as escrow_mint
        from blockchain.solana_verifier import USDC_MINT as verifier_mint
