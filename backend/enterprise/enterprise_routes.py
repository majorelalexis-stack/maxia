...
async def event_stream(request: Request):
    ...
    from routes.admin_routes import _verify_admin
...
async def analytics_agents(period: str = "7d"):
    ...
    try:
        from marketplace.public_api import _registered_agents
        import datetime
...
async def enterprise_fleet(wallet: str, request: Request):
    ...
    from enterprise.fleet_manager import get_fleet_overview
    from core.database import db
...
async def enterprise_toggle_agent(request: Request):
    ...
    from core.security import require_admin
    require_admin(request)
    from enterprise.fleet_manager import toggle_agent
    from core.database import db
...
async def enterprise_compliance(wallet: str, request: Request, period: int = 30):
    ...
    from enterprise.compliance_report import generate_compliance_report
    from core.database import db
