...
from core.config import (
    BASE_RPC, BASE_CHAIN_ID, BASE_USDC_CONTRACT, BASE_USDT_CONTRACT, BASE_MIN_TX_USDC,
    TREASURY_ADDRESS_BASE,
    ETH_RPC, ETH_CHAIN_ID, ETH_USDC_CONTRACT, ETH_USDT_CONTRACT, TREASURY_ADDRESS_ETH,
    POLYGON_RPC, POLYGON_CHAIN_ID, POLYGON_USDC_CONTRACT, POLYGON_USDT_CONTRACT, TREASURY_ADDRESS_POLYGON,
    ARBITRUM_RPC, ARBITRUM_CHAIN_ID, ARBITRUM_USDC_CONTRACT, ARBITRUM_USDT_CONTRACT, TREASURY_ADDRESS_ARBITRUM,
...
evm_verifiers = {
    "base": EvmVerifier("Base", BASE_CHAIN_ID, "base-mainnet",
        ...
        usdt_contract=BASE_USDT_CONTRACT),
    ...
    "avalanche": EvmVerifier("Avalanche", AVALANCHE_CHAIN_ID, "avalanche-mainnet",
        ...
        usdt_contract=AVALANCHE_USDT_CONTRACT),
    "bnb": EvmVerifier("BNB", BNB_CHAIN_ID, "bnb-mainnet",
        ...
        usdt_contract=BNB_USDT_CONTRACT),
...
async def ethereum_info():
    from core.config import ETH_MIN_TX_USDC
    return {
