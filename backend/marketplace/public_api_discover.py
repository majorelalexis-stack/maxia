...
async def chain_support():
    ...
    return {
        ...
        "features": {
            ...
            "scout_scan": {"chains": ["solana", "ethereum", "base", "polygon", "arbitrum", "avalanche", "bnb", "ton", "sui", "near", "aptos", "sei", "xrp", "tron", "zksync", "linea", "scroll", "sonic", "cosmos", "hedera"], "method": "RPC + registries"},
            "payments": {"chains": ["solana", "ethereum", "base", "xrp", "polygon", "arbitrum", "avalanche", "bnb", "ton", "sui", "tron", "near", "aptos", "sei", "zksync", "linea", "scroll", "sonic", "cosmos", "hedera", "bitcoin"], "method": "USDC/USDT on-chain + Lightning sats + IBC", "stablecoins": ["USDC", "USDT"]},
        },
