...
async def _handle_price(intent: ParsedIntent) -> dict:
    ...
    try:
        from pyth_oracle import CRYPTO_FEEDS, EQUITY_FEEDS, get_pyth_price
...
async def _handle_swap(intent: ParsedIntent) -> dict:
    ...
    try:
        from crypto_swap import SUPPORTED_TOKENS, get_swap_quote
...
async def _handle_yield() -> dict:
    ...
    try:
        from yield_aggregator import _fetch_all_yields
