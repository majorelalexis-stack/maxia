...
# ── S49: zkSync Era (16eme blockchain, EVM L2) ──
ZKSYNC_RPC              = os.getenv("ZKSYNC_RPC", "https://mainnet.era.zksync.io")
ZKSYNC_CHAIN_ID         = 324
ZKSYNC_USDC_CONTRACT    = "0x1d17CBcF0D6D143135aE902365D2E5e2A16538D4"
ZKSYNC_USDT_CONTRACT    = "0x493257fD37EDB34451f62EDf8D2a0C418852bA4C"
TREASURY_ADDRESS_ZKSYNC = os.getenv("TREASURY_ADDRESS_ZKSYNC", "")

# ── S49: Linea (17eme blockchain, EVM L2) ──
LINEA_RPC              = os.getenv("LINEA_RPC", "https://rpc.linea.build")
LINEA_CHAIN_ID         = 59144
LINEA_USDC_CONTRACT    = "0x176211869cA2b568f2A7D4EE941E073a821EE1ff"
LINEA_USDT_CONTRACT    = "0xA219439258ca9da29E9Cc4cE5596924745e12B93"
TREASURY_ADDRESS_LINEA = os.getenv("TREASURY_ADDRESS_LINEA", "")

# ── S49: Scroll (18eme blockchain, EVM L2) ──
SCROLL_RPC              = os.getenv("SCROLL_RPC", "https://rpc.scroll.io")
SCROLL_CHAIN_ID         = 534352
SCROLL_USDC_CONTRACT    = "0x06eFdBFf2a14a7c8E15944D1F4A48F9F95F663A4"
