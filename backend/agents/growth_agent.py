...
from blockchain.solana_tx import send_memo_transfer, get_sol_balance
from infra.alerts import alert_prospect_contacted, alert_low_balance, alert_error, alert_system
...
class GrowthAgent:
    ...
    async def _contact_prospect(self, wallet: str, profile: str, analysis: dict):
        ...
        try:
            from core.security import check_financial_limits, record_spend
