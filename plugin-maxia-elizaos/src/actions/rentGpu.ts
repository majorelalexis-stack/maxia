/**
 * MAXIA_RENT_GPU — Browse GPU tiers and pricing on Akash Network via MAXIA.
 */
...
export const rentGpuAction: Action = {
  ...
  description:
    "Browse available GPU tiers on MAXIA (Akash Network). " +
  ...
  handler: async (
    ...
    const res = await maxiaGet<{ tiers: GpuTier[] } | GpuTier[]>(runtime, "/api/public/gpu/tiers");
